    ...
    <head>
        ...
        <script>
            function generateKey() {
                ...
                document.getElementById('mskKey').value = key;
            }
        </script>
    </head>
    <body>
        <div class="container">
            ...
            <form action="RegisterDataOwnerDb" method="post">
                ...
                <label for="mskKey">Master Key:</label>
                <input type="text" id="mskKey" name="mskKey" readonly>

                <button type="button" onclick="generateKey()">Generate Master Key</button>
                <button type="submit" value="submit">Register</button>
            </form>

            <!-- Link to login page -->
            <div class="login-link">
                <p>Already have an account? <a href="ownerLoginPage.jsp">Login here</a></p>
